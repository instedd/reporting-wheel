...
class DecodeControllerTest < ActionController::TestCase
  ...
  test "should return success message specified in wheel" do
    ...
    wheel_combination.expects(:wheel_success_message).returns('My custom message')

    post :wheel, :locale => 'th'

    assert_equal('My custom message', assigns(:message))
  end
  ...
  test "should return success message in Thai" do
    ...
    wheel_combination.expects(:record!)
    wheel_combination.expects(:message).returns('Wheel Decoded Message')
    wheel_combination.expects(:wheel_success_message).returns('')
